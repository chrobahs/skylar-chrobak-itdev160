...
var data = [
  {
    type: postType.admin,
    name: 'Skylar',
    post: 'This is a safe place for Disney fans to post opinions of their favorite
    parks and talk about the pros and cons of the rides and what foods to try or
    miss.'},
  {
    type: postType.sub,
    name: 'Andrea',
    post: 'Can I just say how much I love Be Our Guest in the Magic Kingdom?
    The iconic Grey Stuff is INDEED delicious! I have to remember to ask the chef
    next time for the recipe so I can make it at home.'},
  {
    type: postType.anon,
    name: 'The Duck',
    post: 'Mickey fever is everywhere! This year is his 90th birthday and
    they have just about everything Mickey shaped!There are even Waffles with
    his face on them! Happy though because we have been friends forever.'
  }
];
